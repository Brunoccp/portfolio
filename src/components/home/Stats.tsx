      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 items-start">
          ...
          <div className="flex flex-col gap-8">
            <span className="inline-flex self-start items-center px-3 py-1 rounded-full border border-[rgba(110,232,64,0.3)] text-[#6EE840] text-[10px] font-semibold tracking-[0.12em] uppercase">
              Experiência
            </span>
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[rgba(255,255,255,0.4)] text-xs font-semibold tracking-[0.1em] uppercase mt-2">
                Anos
              </p>
        ...
        {/* Empresas */}
        <div className="mt-12 pt-10 border-t border-[rgba(255,255,255,0.08)] flex flex-col sm:flex-row sm:items-center gap-6">
          <span className="inline-flex self-start sm:self-auto items-center px-3 py-1 rounded-full border border-[rgba(110,232,64,0.3)] text-[#6EE840] text-[10px] font-semibold tracking-[0.12em] uppercase whitespace-nowrap">
            Empresas que atuei
          </span>
          <div className="flex items-center gap-4">
            {[
              ...
              <div
                key={alt}
                className="w-12 h-12 rounded-full bg-white border-2 border-[rgba(255,255,255,0.1)] overflow-hidden flex-shrink-0 flex items-center justify-center"
              >
